  ...
  <section id="content" class="flex">
    ...
    <div id="menu-content" class="flex flex-col w-full pb-[30px]">
      <div class="nav flex justify-between p-5 border-b border-[#EEEEEE]">
        <h1 class="font-extrabold text-[24px]">Tambah Data Pasien</h1>
      ...
      <div class="p-5">
        <form action="{{ route('pasien.store') }}" method="POST" class="bg-white p-6 rounded-lg shadow-md w-full max-w-2xl mx-auto">
          @csrf
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <textarea name="alamat" rows="3" class="w-full border border-gray-300 rounded px-3 py-2" required></textarea>
          </div>
          <div class="mb-4">
            <label class="block font-semibold mb-1">Tanggal Lahir</label>
            <input type="date" name="tanggal_lahir" class="w-full border border-gray-300 rounded px-3 py-2" required>
          </div>
          <div class="mb-4">
          ...
          <div class="flex justify-end">
            <button type="submit" class="bg-[#2B82FE] text-white font-semibold px-6 py-2 rounded-full hover:bg-[#1A6FE0] transition">Simpan</button>
          </div>
        </form>
      </div>
    </div>
